 ...
 * @version 2.0
 * @date 2024-10-29
 * @brief Device specific configuration file for MCXC444 (header file)
 *
...
#ifndef _SYSTEM_MCXC444_H_
#define _SYSTEM_MCXC444_H_                       /**< Symbol preventing repeated inclusion */
